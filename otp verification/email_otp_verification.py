...
password = "qwccnqosqoukjtqx"
server.login("virajnbhutada24@gmail.com",password)

body = "dear"+name+","+"\n"+"\n"+"your OTP is "+str(OTP)+"."
subject = "OTP verification using python"
message = f'subject:{subject}\n\n{body}'

server.sendmail("virajnbhutada24@gmail.com",valid_receiver_email,message)
...
def sending_otp(receiver_email):
    ...
    subject = "OTP verification using python" 
    message = f'subject:{subject}\n\n{body}'
    server.sendmail("virajnbhutada24@gmail.com",receiver_email,message)
